...
fetch("https://raw.githubusercontent.com/mwgg/Airports/master/airports.json")
  ...
  function createSidePanel() {
    ...
    titleBar.textContent = "Travel Airways Logger";
    titleBar.style.padding = "5px";
    titleBar.style.margin = "-10px -10px 10px -10px";
    ...
    airlineLabel.style.color = "white"; // 白色字体
    ...
    document.addEventListener('mousemove', function(e) {
      if (isDragging) {
        panelUI.style.left = (e.clientX - dragOffsetX) + 'px';
        panelUI.style.top = (e.clientY - dragOffsetY) + 'px';
      }
    });
